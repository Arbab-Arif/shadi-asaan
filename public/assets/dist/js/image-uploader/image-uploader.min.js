...
!function (e) {
    e.fn.imageUploader = function (t) {
        ...
        let o = function () {
            ...
            e("<ul>", {class: "uploaded"}).appendTo(t);
            let i = e("<div>", {class: "upload-text"}).appendTo(t);
            e("<i>", {class: "lnr lnr-upload"}).appendTo(i), e("<span>", {text: a.settings.label}).appendTo(i);
            ...
            let l = e("<li>", {class: "uploaded-image"}), r = (e("<img>", {src: t}).appendTo(l), e("<button>", {class: "delete-image"}).appendTo(l));
            e("<i>", {class: "fa fa-trash"}).appendTo(r);
            if (o) {
