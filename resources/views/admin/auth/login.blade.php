...
<head>
    ...
    <title>Login - Admin Shadi Asaan</title>
    <!-- BEGIN: CSS Assets-->
...
<div class="mt-3">
    <div class="md:hidden">
        <img alt="Shadi Asaan" class="-intro-x mx-auto"
...
<div class="container sm:px-10">
    <div class="block xl:grid grid-cols-2 gap-4">
        ...
        <!-- END: Login Info -->
        <!-- BEGIN: Login Form -->
        <form class=" xl:h-auto flex py-5 xl:py-0 my-10 xl:my-0" method="post"
            ...
            <div
                ...
                <div class="intro-x mt-5 xl:mt-8 text-center xl:text-left">
                    ...
                    {{--<button class="btn btn-outline-secondary py-3 px-4 w-full xl:w-32 mt-3 xl:mt-0 align-top">Register
                    </button>--}}
                </div>
