        ...
        <div class="grid grid-cols-12 gap-6 mt-5">
            <div class="intro-y col-span-12 lg:col-span-12">
                <div class="intro-y box">
                    ...
                    <form action="{{route('admin.vendor.update',$vendor->id)}}" method="post" class="p-5"
                          id="form-validation"
                            ...
                            <div class="flex flex-wrap -mx-3 mb-2 sm:grid grid-cols-2 gap-2">
                                ...
                                <div class="w-full md:w-2/3 px-3 mb-6 md:mb-0">
                                    ...
                                    <input type="email" name="email" id="email"
                                           ...
                                           placeholder="Please Enter Your Email" value="{{$vendor->email}}">
                                </div>
                                <div class="w-full md:w-2/3 px-3 mb-6 md:mb-0">
                                    <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2">
                                        Date Of Birth
                                    ...
                                    <input type="date" name="date_of_birth" id="date_of_birth"
                                           ...
                                           value="{{date('Y-m-d', strtotime($vendor->date_of_birth))}}"
                                           max="2999-12-31">
                                </div>
                                {{--                                <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">--}}
                                {{--                                    <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2">--}}
                                ...
                                <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                                    ...
                                    <input type="text" name="cnic_no"
                                           id="cnic_no"
                                           data-inputimask="'mask': '99999-9999999-9'"
                                           class="cols-3 input w-full border mt-2"
                                           placeholder="Enter CNIC No #" min="13" value="{{$vendor->cnic_no}}">
                                </div>
                                {{--<div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                                    <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2">
                                        Status
                                ...
                                <div class="w-full md:w-1/3 px-3 mb-6  md:mb-0">
                                    ...
                                    <input type="tel" name="phone" id="phone"
                                           ...
                                           class="cols-3 input w-full border mt-2"
                                           placeholder="Enter Mobile #" value="{{$vendor->phone ?? '+92'}}"
                                           accept="image/*">
                                </div>
                                <div class="w-full md:w-2/3 px-3 mb-6 md:mb-0">
                                    <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2">
