<x-admin.app>
    <x-slot name="title">
        Shadi Asaan - Create Business Type
    </x-slot>
        ...
        <div class="grid grid-cols-12 gap-6 mt-5">
            <div class="intro-y col-span-12 lg:col-span-12">
                <div class="intro-y box">
                    ...
                    <form action="{{route('admin.business_type.store')}}" method="post" class="p-5" id="form-validation"
                ...
                $(addButton).click(function () {
                    ...
                    if (x < maxField) {
                        var fieldHTML = '<div>' +
                            ...
                            '<label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2">' +
                            'Capacity Name </label>' +
                            '<input type="text" class="cols-3 input w-full border mt-2" id="label" name="label[]" placeholder="Capacity Name " value="">' +
                            '</div>' +
                            '<div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">' +
